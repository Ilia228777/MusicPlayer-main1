...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.LIST_BOX.place(x=20 , y=35)# ААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААА ДИМА ОТВЕТИЛ
        self.SCROLLBAR = ctk.CTkScrollbar(master=self, height = 405, bg_color= "gray", button_color="white", button_hover_color= "lightgray") # Ms. White
        self.SCROLLBAR.place(x = 254, y = 34)
